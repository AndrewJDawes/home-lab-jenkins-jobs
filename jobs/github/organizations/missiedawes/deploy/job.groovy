...
organizationFolder('jobs-v2/github/organizations/missiedawes/deploy') {

    displayName("missiedawes GitHub Deploy")
    ...
    organizations {
        github {
            ...
            credentialsId("github-app-organization-missiedawes")
            traits {
